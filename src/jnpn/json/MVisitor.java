...
/**
 * @class MVisitor : JSON tree visitor for Doclets
 * @param x value of ....
 * @return result of ....
 */
public class MVisitor implements ElementVisitor<Map<String,List<String>>,Map<String,List<String>>> {
    ...
    public MVisitor(DocTrees trees) {
	this.trees = trees;
